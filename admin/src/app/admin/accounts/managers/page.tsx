            ...
            <div className="row">
              <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div className="page-header">
                  <h2 className="pageheader-title">Managers Management</h2>
              ...
              <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div className="card">
                  <div className="card-header d-flex justify-content-between align-items-center">
                    <h5 className="mb-0">Manager List ({pagination.totalCount} total)</h5>
                    <div>
                      ...
                      <Link href="/admin/accounts/add-user" className="btn btn-primary">
                        <i className="fas fa-plus mr-2"></i>Add Manager
                      </Link>
                    </div>
                  </div>
