              ...
              <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div className="card shadow-sm">
                  <div className="card-header d-flex justify-content-between align-items-center">
                    <h5 className="mb-0">Pending Orders List</h5>
                    <div>
                      <button 
            ...
            {showFilterModal && (
              <div className={`modal fade ${modalAnimating ? 'show' : ''}`} style={{display: 'block'}} tabIndex={-1} role="dialog">
                <div className="modal-dialog modal-dialog-centered modal-lg" role="document">
                  <div className="modal-content">
                    <div className="modal-header">
                      <h5 className="modal-title">Filter Pending Orders</h5>
                      <button 
                        type="button" 
                        className="close" 
                        onClick={closeModal}
                    ...
                    <div className="modal-body">
                      ...
                      <div className="alert alert-info mt-3">
                        <i className="fas fa-info-circle mr-2"></i>
                        By default, showing pending orders from last 30 days. Adjust date range to see more orders.
                      </div>
                    </div>
                    <div className="modal-footer">
                      <button 
