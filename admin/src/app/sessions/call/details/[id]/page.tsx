...
export default function CallSessionDetailPage() {
  ...
  useEffect(() => {
    if (session) {
      document.title = `Call Session ${session.session_id} | True Astrotalk`;
    } else {
      document.title = 'Call Session Details | True Astrotalk';
    }
  }, [session]);
          ...
          <div className="dashboard-ecommerce">
            <div className="container-fluid dashboard-content">
              <div className="alert alert-danger">
                <h4>Error</h4>
                <p>{error}</p>
                <Link href="/sessions/call" className="btn btn-primary">
          ...
          <div className="dashboard-ecommerce">
            <div className="container-fluid dashboard-content">
              <div className="alert alert-warning">
                ...
                <p>The requested call session could not be found.</p>
                <Link href="/sessions/call" className="btn btn-primary">
                  Back to Call Sessions
                </Link>
              </div>
            ...
            <div className="row">
              <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                <div className="page-header">
                  <h2 className="pageheader-title">Call Session Details</h2>
                  <p className="pageheader-text">Detailed information about call session {session.session_id}</p>
                  <div className="page-breadcrumb">
                    <nav aria-label="breadcrumb">
                      <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item">
                          <Link href="/sessions/call" className="breadcrumb-link">Call Sessions</Link>
                        </li>
                        ...
                        <table className="table table-borderless">
                          <tbody>
                            <tr>
                              ...
                              <td><code className="text-primary">{session.session_id || 'N/A'}</code></td>
                            </tr>
                            <tr>
                        ...
                        <table className="table table-borderless">
                          <tbody>
                            <tr>
                              ...
                              <td>₹{session.call_rate || 'N/A'}</td>
                            </tr>
                            <tr>
                              <td><strong>Total Amount:</strong></td>
                              <td><strong className="text-success">₹{session.total_amount || 0}</strong></td>
                            </tr>
            ...
            <div className="row">
              <div className="col-12">
                <div className="text-left">
                  <Link href="/sessions/call" className="btn btn-secondary">
