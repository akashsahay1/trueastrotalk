        ...
        <div className="bg-white rounded-lg shadow-lg p-8">
          ...
          <div className="prose prose-gray max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">General Description</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">Registration and Eligibility</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">FEATURE "CALL WITH ASTROLOGER"</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">First Free Chat/Call</h3>
              <ul className="list-disc pl-6 text-gray-700 mb-4">
                <li className="mb-2">We offer each unique user a first free chat or call, with a maximum duration of 3 minutes. A "unique user," as defined by the Site/App, is an individual whose mobile number or device have not been previously registered with Us or any of its subsidiaries.</li>
                <li>We reserve the right to withdraw this promotion at any time without giving prior notice or reason to the users.</li>
              </ul>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">Content/Service</h2>
              <ul className="list-disc pl-6 text-gray-700">
                <li className="mb-2">Any information provided on or by the Site/App should not be considered as medical, legal, financial or mental health advice.</li>
                <li className="mb-2">The content available on Site/App does not represent or warrant that any specific medication, treatment, or procedure is safe, suitable, or effective for any User.</li>
                <li className="mb-2">Site/App does not provide any guarantees regarding the services or advice rendered by third-party service providers, including registered astrologers.</li>
                <li className="mb-2">Site/App does not guarantee any specific outcomes or results from the services provided.</li>
                <li>By utilizing Site/App and its services, you agree that any legal remedies or liabilities arising from actions or omissions of other Members shall be limited to claims against the specific party deemed responsible.</li>
              </ul>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">USER ACCOUNT ACCESS</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">BREACH AND TERMINATION</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">USER OBLIGATION</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <p className="text-gray-700 leading-relaxed mb-2"><strong>While using the Site/App, the User agrees not to:</strong></p>
              <ul className="list-disc pl-6 text-gray-700 mb-4">
                <li className="mb-1">Post inappropriate, false, misleading, or harmful content</li>
                <li className="mb-1">Share unauthorized content or infringe intellectual property rights</li>
                <li className="mb-1">Collect personal information of other members for solicitation</li>
                <li className="mb-1">Send unsolicited communications or spam</li>
                <li className="mb-1">Distribute harmful files or viruses</li>
                <li className="mb-1">Interfere with platform access or attempt unauthorized access</li>
                <li className="mb-1">Engage in commercial exploitation without consent</li>
                <li className="mb-1">Transmit objectionable material or encourage illegal conduct</li>
              </ul>
            </section>

            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">Content Policies</h2>
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Black Magic, Witchcraft, Voodoo and Tantrism</h3>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">DELIVERY, CANCELLATION AND REFUND</h2>
              
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Refunds on Wallet Recharges</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-3">Refunds of Service Charges</h3>
              <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">DISCLAIMER/LIMITATION OF LIABILITY</h2>
              <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                <strong>Important:</strong> The Services offered by the Site/App are for entertainment purposes only. The Site/App is not a suicide helpline. If you are contemplating suicide or in immediate danger, please seek help from a licensed professional immediately.
              </p>
            </section>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">PROPRIETARY RIGHTS TO CONTENT</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-gray-900 mb-4">GRIEVANCE OFFICER</h2>
              <p className="text-gray-700 leading-relaxed">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 text-gray-700 mb-4">
                <li className="mb-2"><strong>Personal Data:</strong> We collect personal information that you provide when creating an account, including your name, contact number, email, date of birth, gender, and any other details you voluntarily provide.</li>
                <li className="mb-2"><strong>Payment Information:</strong> To process transactions, we collect payment details through secure third-party payment gateways.</li>
                <li className="mb-2"><strong>Device Data:</strong> We automatically gather technical data, such as IP addresses, browser type, device identifiers, and cookies, to enhance your experience and provide a personalized experience.</li>
                <li className="mb-2"><strong>Usage Data:</strong> We may collect data regarding your interactions with our platform, including your preferences, to optimise our services and offerings.</li>
                <li className="mb-2"><strong>Chat History:</strong> We may collect the information you share with Astrologers via Chat or Voice & Video channels for internal audit and training purposes.</li>
              </ul>

              <h3 className="text-xl font-semibold text-gray-900 mb-3">How We Use Your Information</h3>
              <p className="text-gray-700 leading-relaxed mb-2">We use the information we collect for the following purposes:</p>
              <ul className="list-disc pl-6 text-gray-700 mb-4">
                <li className="mb-1"><strong>Service Delivery:</strong> To facilitate consultations, communication between astrologers and clients, and process transactions.</li>
                <li className="mb-1"><strong>Personalization:</strong> To customize your experience and recommend relevant content and services.</li>
                <li className="mb-1"><strong>Marketing and Communication:</strong> To send promotional offers, newsletters, and updates through email, SMS, and WhatsApp.</li>
                <li className="mb-1"><strong>Customer Support:</strong> To respond to your inquiries and provide assistance.</li>
                <li className="mb-1"><strong>Analytics and Improvements:</strong> To analyse usage patterns, improve service quality, and develop new features.</li>
              </ul>
              ...
              <ul className="list-disc pl-6 text-gray-700 mb-4">
                ...
                <li className="mb-1"><strong>Legal Obligations:</strong> When required by law or to protect our rights, privacy, safety, or property.</li>
                <li className="mb-1"><strong>Business Transfers:</strong> In the event of mergers, acquisitions, or asset sales, user data may be transferred.</li>
              </ul>
