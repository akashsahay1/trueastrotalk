...
$(function() {
    ...
    //     sparkResize = setTimeout(sparklineRevenue, 500);
    // });
    // sparklineRevenue()


    if ($("#chartjs_balance_bar").length) {
        // Chart Balance Bar
    ...
    // Disputed vs Overdue Invoices
    if ($(".ct-chart-line-invoice").length) {
