...
import 'rate_management.dart';
import '../wallet/wallet.dart';
import '../profile/profile.dart';
import '../profile/edit_personal_info.dart';
import '../profile/edit_professional_info.dart';
import '../profile/edit_session_rates.dart';
import '../profile/edit_bank_details.dart';
import '../profile/edit_address.dart';
...
class _AstrologerDashboardScreenState extends State<AstrologerDashboardScreen> {
  ...
  Future<void> _loadDashboardData() async {
    ...
    try {
      // Refresh current user from auth service
      _currentUser = await _authService.refreshCurrentUser();

      // Update profile completion service
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              if (_profileCompletionService.needsProfileCompletion) ...[
  ...
  Widget _buildProfileCompletionBanner() {
    final incompleteSections = _profileCompletionService.incompleteSections;
    final completionPercentage = _profileCompletionService.completionPercentage;
      ...
      child: Column(
        ...
        children: [
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        _profileCompletionService.summaryMessage,
          ...
          Container(
            ...
            child: Column(
              children: incompleteSections.map((section) {
                return _buildIncompleteSection(section);
              }).toList(),
            ),
          ),
          const SizedBox(height: 16),
  ...
  Widget _buildIncompleteSection(ProfileSection section) {
    return InkWell(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (section.missingFields.isNotEmpty)
                    Text(
                      'Missing: ${section.missingFields.take(2).join(", ")}${section.missingFields.length > 2 ? "..." : ""}',
                      style: AppTextStyles.bodySmall.copyWith(
  ...
  void _navigateToSection(ProfileSection section) {
    Widget? screen;
    ...
    switch (section.routeName) {
      ...
      case 'editBankDetails':
        ...
        break;
      case 'editAddress':
        screen = const EditAddressScreen();
        break;
    }
