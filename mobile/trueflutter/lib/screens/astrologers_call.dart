...
enum SortBy { name, callRate, rating, experience }
enum FilterBy { all, online, offline }

class AstrologersCallScreen extends StatefulWidget {
  final UserApiService userApiService;
  final Function(Astrologer) onAstrologerTap;
  final Function(Astrologer) onStartCall;

  const AstrologersCallScreen({
    super.key,
  ...
  @override
  State<AstrologersCallScreen> createState() => _AstrologersCallScreenState();
}

class _AstrologersCallScreenState extends State<AstrologersCallScreen> {
  ...
  SortBy _currentSort = SortBy.callRate;
  ...
  SortBy _tempSort = SortBy.callRate;
  ...
  void _applyFiltersAndSort() {
    ...
    // Apply sorting - default to call rate for call screen
    switch (_currentSort) {
      case SortBy.name:
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Call Astrologers', style: AppTextStyles.heading4.copyWith(color: AppColors.white)),
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return Padding(
            ...
            child: AstrologerCallCard(
              astrologer: astrologer,
              onTap: () => widget.onAstrologerTap(astrologer),
              onStartCall: () => widget.onStartCall(astrologer),
            ),
          );
        },
      ),
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        _buildSortOption('Call Rate (Low to High)', SortBy.callRate, setDialogState),
