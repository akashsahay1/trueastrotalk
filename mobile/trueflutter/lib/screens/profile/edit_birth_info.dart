...
class _EditBirthInfoScreenState extends State<EditBirthInfoScreen> {
  ...
  final _birthTimeController = TextEditingController(text: '07:30 PM');
  ...
  Future<void> _loadUserData() async {
    try {
      ...
      if (user != null) {
        _selectedBirthDate = user.dateOfBirth ?? DateTime(2000, 1, 1);
        _birthTimeController.text = (user.timeOfBirth?.isNotEmpty == true)
            ? user.timeOfBirth!
            : '07:30 PM';
        _birthPlaceController.text = (user.placeOfBirth?.isNotEmpty == true)
            ? user.placeOfBirth!
            : 'New Delhi, India';
