  ...
  Future<void> _loadData() async {
    try {
      ...
      if (user != null) {
        ...
        _isAdminVerified = user.isAdminVerified;
              ...
              child: Form(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Info message for pending astrologers
                    ...
                    // Update Button or Contact Support (locked after admin approval)
                    if (_isProfileLocked)
                      Container(
                        padding: const EdgeInsets.all(16),
                        decoration: BoxDecoration(
                        ...
                        child: Column(
                          children: [
                            ...
                            const SizedBox(height: 12),
                            Text(
                              'Your profile has been approved. To update your details, please contact our support team.',
